package sxf.term.androidadvance.bigview;
...
public class BigView extends View implements GestureDetector.OnGestureListener, View.OnTouchListener {
    ...
    public BigView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
     ...
     * @param e1        按下
     * @param e2        移动
     * @param distanceX 左右移动距离
     * @param distanceY 上下移动距离
     * @return
     */
    @Override
